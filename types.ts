...
export const PERMISSIONS = {
  ...
  VIEW_WORKLOAD_STATS: "workload_stats_view",
  ...
  VIEW_MEETING_ROOM: "meeting_room_view",
  EDIT_MEETING_ROOM: "meeting_room_edit",
...
export const PERMISSION_LABELS: Record<string, string> = {
  ...
  [PERMISSIONS.VIEW_WORKLOAD_STATS]: "查看放射師工作量統計",
  ...
  [PERMISSIONS.VIEW_MEETING_ROOM]: "查看會議室時段與租借紀錄",
  [PERMISSIONS.EDIT_MEETING_ROOM]: "新增或取消會議室預約",
...
export interface User {
  ...
  unlockedSkills?: string[]; // New: List of gamified skills the user has unlocked
  learningSkills?: string[]; // New: List of gamified skills the user is currently learning
...
export interface Shift {
  ...
  workTime?: string; // Daily working hours (e.g. "08:00-16:00")
...
export interface RadiographerWorkload {
  ...
  tsmcReport?: number;
  mrTeaching?: number;
  mrLargeMaleTeaching?: number;
  mrLargeFemaleTeaching?: number;
  mrMediumTeaching?: number;
  mrSmallTeaching?: number;
  usTeaching?: number;
  usATeaching?: number;
  usBreastTeaching?: number;
  usHeartTeaching?: number;
  usThyTeaching?: number;
  usCCATeaching?: number;
