...
import { Plus, Trash2, Save, Settings, Calendar, AlertCircle, Users, Clock, Globe, X, RefreshCw } from 'lucide-react';
...
const SettingsPage: React.FC<SettingsPageProps> = ({ currentUser }) => {
  ...
  // Allow both Supervisor and System Admin to access settings
  if (currentUser.role !== UserRole.SUPERVISOR && currentUser.role !== UserRole.SYSTEM_ADMIN) {
    return <div className="p-8 text-center text-gray-500">權限不足，僅限主管與系統管理員訪問。</div>;
  }
    ...
    <div className="p-6 max-w-7xl mx-auto h-screen overflow-y-auto">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
            ...
            <p className="text-sm text-gray-500">管理工作崗位、每日人力需求與排班週期</p>
        </div>
      </div>

      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        
        {/* Cycle Calculation Settings (New) */}
