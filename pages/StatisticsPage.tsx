...
const StatisticsPage: React.FC<StatisticsPageProps> = ({ currentUser }) => {
  ...
  // Default to the first cycle (latest) if available, otherwise 'rolling'
  const [selectedCycleId, setSelectedCycleId] = useState<string>(cycles.length > 0 ? cycles[0].id : 'rolling'); 
         ...
         <div className="flex justify-between items-center">
             <div className="flex items-center gap-4">
                 ...
                 <div>
                     ...
                     <p className="text-xs text-slate-500 font-medium">統計範圍: {cycleName}</p>
                 </div>
             </div>
